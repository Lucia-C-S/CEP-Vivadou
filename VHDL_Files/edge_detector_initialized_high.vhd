...
entity edge_detector_initialized_high is
...
end edge_detector_initialized_high;

architecture Behavioral of edge_detector_initialized_high is
signal input_t_1: std_logic:='1';
signal input_sync_aux: std_logic:='1';
begin
...
begin
	if reset = '1' then 	input_sync_aux <= '1';
								input_t_1 <= '1';
